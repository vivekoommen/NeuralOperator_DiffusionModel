...
x_train = np.load("../TRAIN_PRED.npy")[:,0]
y_train = np.load("../TRAIN_TRUE.npy")[:,0]

x_val = np.load("../VAL_PRED.npy")[:,0]
y_val = np.load("../VAL_TRUE.npy")[:,0]

x_test = np.load("../TEST_PRED.npy")[:,0]
y_test = np.load("../TEST_TRUE.npy")[:,0]
